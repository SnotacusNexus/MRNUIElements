...
namespace Shape_Shifter.View
{
    ...
    public partial class ZoomPanWindow : Window
    {
        ...
        {
            this.Owner = (this.DataContext as Shape_Shifter.MainWindow);

        }

        void Zoom_Closed(object sender, EventArgs e)
        {
            (this.DataContext as Shape_Shifter.MainWindow).Isopen = true;
        }
        ...
        {
            ((this.DataContext as Shape_Shifter.MainWindow).DataContext as Shape_Shifter.ViewModel.DiagramBuilderVM).OnZoomCommand(textbox.Text);
           (this.DataContext as Shape_Shifter.MainWindow).Isopen=true;
            this.Close();
        }
