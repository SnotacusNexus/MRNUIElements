...
namespace MRNUIElements
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            dTOLUClaimDocumentTypeBindingSource.DataSource = s1.ClaimDocTypes;
     ...
     async  public void UploadDocuments(DTO_Claim claim, DTO_LU_ClaimDocumentType docType, string filePath)
        {
